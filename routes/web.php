...
Route::get('/empresa/proveedores', [ProveedoresController::class, 'create'])->name('mostrar.proveedores');

Route::post('/empresa/proveedores', [ProveedoresController::class, 'store'])->name('crear.proveedores');
